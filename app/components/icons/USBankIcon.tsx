const USBankIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width={73.3} height={73.3}>
    ...
    <path
      d="M36.6 50.7H25.4v-3.9h-.1c-2.2 3.1-5.3 4.6-9.9 4.6C9.9 51.4 5 48.1 5 41.1V20.2h11.6v16c0 3.5.4 6 3.8 6 2 0 4.6-1 4.6-5.9V20.2h11.6zm21.7-21.6c-.1-1-.6-1.8-1.4-2.3-.7-.6-1.6-.9-2.6-.9-1.6 0-3.5.4-3.5 2.3 0 .9.7 1.3 1.4 1.6 1.9.8 6.3 1.1 10.2 2.3 3.9 1.2 7.3 3.5 7.3 8.5 0 8.5-8.1 10.7-15.5 10.7-7.2 0-15-2.9-15.2-10.7h11.1c.1 1.1.5 1.9 1.4 2.7.6.5 1.7.9 3.1.9 1.5 0 3.9-.6 3.9-2.3 0-1.8-1-2.3-6.4-3.2-8.9-1.5-12.4-4.3-12.4-9.6 0-7.7 8.3-9.7 14.4-9.7 6.6 0 14.5 1.8 14.8 9.6H58.3z"
      fill="#fff"
    />
  </svg>
);
